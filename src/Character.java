...
public class Character implements Serializable {
	...
	int accuracy; // modifies chances of landing an attack (minor, major,
					// excellent) and slight melee/spell damage bonus.
	...
	// Update names, damage, and armor whenever you load or change equipped
	// pieces
	...
	public void setLocation(String characterLocation) {
